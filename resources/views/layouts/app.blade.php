                 ...
                 <div class="container">
                     <div class="row">
                         <div class="col d-flex flex-row">
                             ...
                             <div class="top_bar_contact_item">
                                 <div class="top_bar_icon"><img src="{{ asset('public/frontend/images/mail.png')}}" alt=""></div><a href="mailto:fastsales@gmail.com">{{ $setting->email }}</a>
                             </div>
                             <div class="top_bar_content ml-auto">
                                 ...
                                 <div class="top_bar_menu">
                                     <ul class="standard_dropdown top_bar_dropdown">
                                         ...
                                         <li>
                                             ...
                                             @else
                                             <a href="{{ route('language.vn') }}">VN<i class="fas fa-chevron-down"></i></a>
                                             @endif
                                 ...
                                 <div class="top_bar_user">
                                     ...
                                     <div><a href="{{ route('login') }}">
                                             <div class="user_icon"><img src="{{ asset('public/frontend/images/user.svg')}}" alt=""></div> Register/Login
                                         </a></div>
                                     @else
                                     ...
                                     <ul class="standard_dropdown top_bar_dropdown">
                                         <li>
                                             <a href="{{ route('home') }}">
                                                 <div class="user_icon"><img src="{{ asset('public/frontend/images/user.svg')}}" alt=""></div> Profile<i class="fas fa-chevron-down"></i>
                                             </a>
                                             <ul>
                                 ...
                                 <div class="cart">
                                     <div class="cart_container d-flex flex-row align-items-center justify-content-end">
                                         ...
                                         <div class="cart_content">
                                             ...
                                             <div class="cart_price">{{ Cart::subtotal() }}VND</div>
                                         </div>
                                     </div>
                                 </div>
                             </div>
                         ...
                         <div class="col">
                             ...
                             <div class="copyright_container d-flex flex-sm-row flex-column align-items-center justify-content-start">
                                 <div class="copyright_content">
                                     ...
                                     </script> Censor.vn All rights reserved
                                     <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                                 </div>
