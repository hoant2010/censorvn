 ...
 <head>
   ...
   <meta property="og:title" content="Cencor.vn">
 ...
 <body>
   ...
   @else
   <!-- ########## START: LEFT PANEL ########## -->
   <div class="sl-logo"><a href=""><i class="icon ion-android-star-outline"></i>CENCOR.VN</a></div>
       ...
       <nav class="nav">
         <div class="dropdown">
           <a href="" class="nav-link nav-link-profile" data-toggle="dropdown">
             ...
             <img src="{{ asset('public/backend/img/img9.jpg') }} " class="wd-32 rounded-circle" alt="">
           </a>
